...
const lv_img_dsc_t * ui_imgset_161032494[1] = {&ui_img_1901514184};
...
void xinglv_Animation(lv_obj_t * TargetObject, int delay)
{
    ...
    lv_anim_set_values(&PropertyAnimation_1, 0, 512);
    ...
    lv_anim_set_time(&PropertyAnimation_2, 1200);
    ...
    lv_anim_set_values(&PropertyAnimation_2, 0, 512);
    ...
    lv_anim_set_time(&PropertyAnimation_3, 1600);
    ...
    lv_anim_set_values(&PropertyAnimation_3, 0, 512);
    lv_anim_set_path_cb(&PropertyAnimation_3, lv_anim_path_linear);
    lv_anim_set_delay(&PropertyAnimation_3, delay + 1200);
